    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('xbox_id', models.CharField(blank=True, default='', max_length=255)),
                ('last_email_reset', models.DateTimeField(auto_now=True)),
                ('graduation_year', models.CharField(max_length=4)),
                ('notifications_channel', models.CharField(default=users.models.create_notification_channel, max_length=10)),
